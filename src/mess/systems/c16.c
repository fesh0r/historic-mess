/***************************************************************************
	...
	simple and quick commodore c16 home computer
...
#define DIPS_BOTH \
	...
	PORT_DIPSETTING(  4, "IEC Port 0/C1551 Floppy Drive" )\
	PORT_DIPNAME ( 0x03, 0x01, "Device 9")\
	PORT_DIPSETTING(  0, "None" )\
	PORT_DIPSETTING(  1, "IEC Port 1/C1551 Floppy Drive" )\
	PORT_START
#if 0
	PORT_DIPNAME ( 0x0c, 0x08, "Device 8")\
	PORT_DIPSETTING(  0, "None" )\
	PORT_DIPSETTING(  4, "IEC Port 0/C1551 Floppy Drive" )\
	PORT_DIPSETTING(  8, "Serial Bus/VC1541 Floppy Drive" )\
	PORT_DIPNAME ( 0x03, 0x00, "Device 9")\
	PORT_DIPSETTING(  0, "None" )\
	PORT_DIPSETTING(  1, "IEC Port 1/C1551 Floppy Drive" )\
