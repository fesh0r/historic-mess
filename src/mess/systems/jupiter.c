...
static struct MemoryReadAddress jupiter_readmem[] = {
	...
	{ 0x2400, 0x26ff, jupiter_vh_scrnram_r },
	{ 0x2700, 0x27ff, MRA_RAM },
	{ 0x2800, 0x2bff, MRA_NOP },
	{ 0x2c00, 0x2fff, jupiter_vh_charram_r },
...
static struct MemoryWriteAddress jupiter_writemem[] = {
	...
	{ 0x2400, 0x26ff, jupiter_vh_scrnram_w },
	{ 0x2700, 0x27ff, MWA_RAM },
	{ 0x2800, 0x2bff, MWA_NOP },
	{ 0x2c00, 0x2fff, jupiter_vh_charram_w },
...
static struct GfxLayout jupiter_charlayout = {
	8, 8,
	1,
	1,                      /* 1 bits per pixel */
...
static struct GfxDecodeInfo jupiter_gfxdecodeinfo[] = {
	{ 0, 0x0, &jupiter_charlayout, 0, 0x02 },
	{ -1 } /* end of array */
};
...
struct GameDriver jupiter_driver =
{
	...
	GAME_COMPUTER | ORIENTATION_DEFAULT | GAME_NO_SOUND,    /* orientation */
	0, 0,
};
